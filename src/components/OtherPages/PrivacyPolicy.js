...
function PrivacyPolicy() {
  return (
    <motion.div
      ...
      <h1>INFORMATION PROVIDED DIRECTLY BY YOU
      </h1>
      ...
      <h1>INFORMATION COLLECTED THROUGH YOUR USE OF OUR SERVICES
      </h1>
      <p>The following are situations in which you may provide Your Information to us:
      </p>
      <ol>
        <li>When you fill out forms or fields through our Services;
        </li>
        <li>When you register for an account with our Service;
        </li>
        <li>When you create a subscription for our newsletter or Services;
        </li>
        <li>When you provide responses to a survey;
        </li>
        <li>When you answer questions on a quiz;
        </li>
        <li>When you join or enroll in an event through our Services;
        </li>
        <li>When you order services or products from, or through our Service;
        </li>
        <li>When you provide information to us through a third-party application, service or Website;
        </li>
        <li>When you communicate with us or request information about us or our products or Services, whether via email or other means; and
        </li>
        <li>When you participate in any of our marketing initiatives, including, contests, events, or promotions.
        </li>
      </ol>
      ...
      <p>We also automatically collect information via the Website through the use of various technologies, including, but not limited to Cookies and Web Beacons (explained below). We may collect your IP address, browsing behavior and device IDs. This information is used by us in order to enable us to better understand how our Services are being used by visitors and allows us to administer and customize the Services to improve your overall experience.
        <h1>INFORMATION COLLECTED FROM OTHER SOURCES
        </h1>
      </p>
      ...
      <h1>INFORMATION THIRD PARTIES PROVIDE
      ...
      <p>When you use the Services we may collect your precise location data. We may also derive your approximate location from your IP address.
      </p>
      <h1>PROTECTIVE MEASURES WE USE
      </h1>
      ...
      <h1>INTERNATIONAL PRIVACY POLICIES
      </h1>
      ...
      <h1>PROMOTIONAL INFORMATION OPT OUT
      </h1>
      ...
      <h1>OUR INFORMATION RETENTION POLICY
      </h1>
      ...
      <p>If you have any questions or if you would like to contact us about our processing of your personal information, including exercising your rights as outlined above, please contact us by any of the methods below. When you contact us, we will ask you to verify your identity.
